...
public class ProgramaPrincipal {
    ...
    public static void menuLogin(Usuari usuari) {
        ...
        System.out.println("|");
        System.out.println("|              2. Crear Pel·licula.");
        System.out.println("|");
    ...
    public static void menuAdmin(Usuari usuari) {
        System.out.println("|");
        System.out.println("|");
        System.out.println("|     BENVINGUT "+usuari.getNombre()+"! Tria una opció:");
        System.out.println("|");
        ...
        System.out.println("|");
        System.out.println("|              3. Crear Pel·licula.");
        System.out.println("|");
        System.out.println("|              4. Eliminar Pel·licula.");
        System.out.println("|");
        System.out.println("|              5. Crear Actor.");
        System.out.println("|");
